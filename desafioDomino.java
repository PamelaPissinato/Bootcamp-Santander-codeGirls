//Desafio
//O tradicional jogo de dominó possui 28 peças, sendo que cada peça está dividida em dois quadrados e dentro de cada quadrado há entre 0 e 6 círculos. O jogo é chamado também de duplo-6 porque esse é o maior número de círculos que aparece num quadrado de uma peça.
...
//Entrada - A primeira linha da entrada contém um número natural N representando o tipo do jogo de dominó: duplo-N.

//Saída - Seu programa deve imprimir uma linha contendo um número natural representando quantas peças existem num jogo de dominó do tipo duplo-N.
...
public class desafioDomino {
	public static void main(String[] args) {
        ...
        if(0 >= n || n <= 10000) {
            System.out.println("Quantidade de peças: " + ((n+1)*(n+2))/2);
        } else{
